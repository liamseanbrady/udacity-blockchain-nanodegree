...
VOLUME_MAPPING="${DIR}/src:/practice-private-blockchain/src"
# Build the Docker image
echo "Building the Docker image for this project..."
docker build --tag practice-private-blockchain $DIR/.
...
docker container run --rm --interactive --tty --volume $VOLUME_MAPPING --name practice-private-blockchain practice-private-blockchain sh
