...
VOLUME_MAPPING="${DIR}/src:/private-blockchain-project/src"
# Build the Docker image
echo "Building the Docker image for this project..."
docker build --tag private-blockchain-project $DIR/.
...
docker container run --rm --interactive --tty --volume $VOLUME_MAPPING --name private-blockchain-project private-blockchain-project sh
