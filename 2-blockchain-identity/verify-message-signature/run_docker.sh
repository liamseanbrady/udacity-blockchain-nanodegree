...
VOLUME_MAPPING="${DIR}/src:/verify-message-signature/src"
# Build the Docker image
echo "Building the Docker image for this project..."
docker build --tag verify-message-signature $DIR/.
...
docker container run --rm --interactive --tty --volume $VOLUME_MAPPING --name verify-message-signature verify-message-signature sh
