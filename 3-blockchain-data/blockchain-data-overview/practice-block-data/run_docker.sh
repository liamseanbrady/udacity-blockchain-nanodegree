...
VOLUME_MAPPING="${DIR}/src:/practice-block-data/src"
# Build the Docker image
echo "Building the Docker image for this project..."
docker build --tag practice-block-data $DIR/.
...
docker container run --rm --interactive --tty --volume $VOLUME_MAPPING --name practice-block-data practice-block-data sh
