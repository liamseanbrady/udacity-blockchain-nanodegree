...
VOLUME_MAPPING="${DIR}/src:/merkle-tree-practice/src"
# Build the Docker image
echo "Building the Docker image for this project..."
docker build --tag merkle-tree-practice $DIR/.
...
docker container run --rm --interactive --tty --volume $VOLUME_MAPPING --name merkle-tree-practice merkle-tree-practice sh
